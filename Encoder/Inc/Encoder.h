...
// Masks
#define ENCODER_MASK      0x07FB // To extract the first 10 bits from the reading
#define ENCODER_2BITS	  0x0003 // extract first 2 bits
#define ENCODER_8BITS 	  0x03FC // extract last 8 bits
#define ENCODER_RAW_MASK  0x03FF // Isolate full reading
/*=============================================================================*/
